...
namespace TapCap.Supplier.Model
{
    ...
    public partial class TapCapToken :  IEquatable<TapCapToken>
    {
        ...
        public TapCapToken(string clientAccount = default(string), double? availableBalance = default(double?), decimal? transactionId = default(decimal?), double? timestamp = default(double?))
        {
