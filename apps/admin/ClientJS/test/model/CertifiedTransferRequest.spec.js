...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @TheCoinBrokerCad.CertifiedTransferRequest();
  });
  ...
  describe('CertifiedTransferRequest', function() {
    it('should create an instance of CertifiedTransferRequest', function() {
      // uncomment below and update the code to test CertifiedTransferRequest
      //var instane = new @TheCoinBrokerCad.CertifiedTransferRequest();
      //expect(instance).to.be.a(@TheCoinBrokerCad.CertifiedTransferRequest);
    });
