  ...
  describe('TransactionsApi', function() {
    describe('tapCapBroker', function() {
      it('should call tapCapBroker successfully', function(done) {
        ...
        //instance.tapCapBroker(function(error) {
    ...
    describe('tapCapClient', function() {
      it('should call tapCapClient successfully', function(done) {
        //uncomment below and update the code to test tapCapClient
        //instance.tapCapClient(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
