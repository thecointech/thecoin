...
namespace TheCoinCore.Client
{
    ...
    public partial class ApiClient
    {
        ...
        public ApiClient()
        {
            Configuration = TheCoinCore.Client.Configuration.Default;
            RestClient = new RestClient("https://thecoincore-212314.appspot.com");
            RestClient.IgnoreResponseStatusCode = true;
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="ApiClient" /> class
        /// with default base path (https://thecoincore-212314.appspot.com).
        /// </summary>
        /// <param name="config">An instance of Configuration.</param>
        public ApiClient(Configuration config)
        {
            Configuration = config ?? TheCoinCore.Client.Configuration.Default;
        ...
        public ApiClient(String basePath = "https://thecoincore-212314.appspot.com")
        {
