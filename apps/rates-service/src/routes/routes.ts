...
export function RegisterRoutes(app: express.Router) {
    ...
    // ###########################################################################################################
        app.get('/api/v1/rates/:currencyCode',
            function RatesController_getSingle(request: any, response: any, next: any) {
            const args = {
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.get('/api/v1/many',
            function RatesController_getMany(request: any, response: any, next: any) {
            const args = {
        ...
        app.get('/api/v1/doUpdate',
            function UpdateController_doUpdate(request: any, response: any, next: any) {
            const args = {
            };
