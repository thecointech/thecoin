...
import type { ChequeBalanceResult, ETransferInput, ETransferResult, VisaBalanceResult } from '@thecointech/scraper-agent/types';
...
export async function sendETransfer(callbacks: HarvesterReplayCallbacks, dynamicValues: ETransferInput, delay = 5000): Promise<ETransferResult> {
