...
@router.post("/credit-details/current-balance", tags=["credit-details"])
...
@router.post("/credit-details/current-pending", tags=["credit-details"])
...
@router.post("/credit-details/current-due-amount", tags=["credit-details"])
...
@router.post("/credit-details/current-due-date", tags=["credit-details"])
