...
transfer_complete_prompt = "Anaylze this online banking page with the the title \"{title}\". Is sending the etransfer complete?"

def query_etransfer_complete(title: str) -> tuple[str, ETransferCompleteResponse]:
    return (
        transfer_complete_prompt.format(title=title),
