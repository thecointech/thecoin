...
export type AccountKYC = {
  ...
  // Certificates generated by Blockpass
  ...
  // Phone details as registered by Blockpass
  phone?: AccountKYCPhone;
  // Currently always false (we don't check phone numbers)
  ...
  // Status of KYC
  status?: StatusType;
  // The timestamp of when -we- processed this
