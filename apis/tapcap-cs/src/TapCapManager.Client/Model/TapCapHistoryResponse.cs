...
namespace TapCapManager.Client.Model
{
    ...
    public partial class TapCapHistoryResponse :  IEquatable<TapCapHistoryResponse>
    {
        ...
        public TapCapHistoryResponse(List<TapCapCompletedTransaction> history = default(List<TapCapCompletedTransaction>))
        {
        ...
        public List<TapCapCompletedTransaction> History { get; set; }
