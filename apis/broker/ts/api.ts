 ...
 * 
 * @export
 * @interface ReferralCreateBody
 */
export interface ReferralCreateBody {
    /**
     * 
     * @type {string}
     * @memberof ReferralCreateBody
     */
    code: string;
    /**
     * 
...
export const DirectTransferApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * Transfer to another The Coin account A client may request that the Broker initiate a transfer from their account to another. The transfer includes a fee paid to the broker to cover the cost of the transfer. This allows a user to operate on the Ethereum blockchain without requiring their own ether  request CertifiedTransferRequest A request appropriately filled out and signed returns CertifiedTransferResponse
...
export const NewsletterApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {string} id 
         * @param {SubscriptionData} details 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        newsletterUpdate: async (id: string, details: SubscriptionData, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
...
export const NewsletterApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async newsletterUpdate(id: string, details: SubscriptionData, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<SubscriptionDetails>> {
...
export const NewsletterApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        newsletterUpdate(id: string, details: SubscriptionData, options?: any): AxiosPromise<SubscriptionDetails> {
...
export class NewsletterApi extends BaseAPI {
     ...
     * @memberof NewsletterApi
     */
    public newsletterUpdate(id: string, details: SubscriptionData, options?: any) {
...
export const ReferralsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {ReferralCreateBody} [body] 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        referralCreate: async (body?: ReferralCreateBody, options: any = {}): Promise<RequestArgs> => {
...
export const ReferralsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async referralCreate(body?: ReferralCreateBody, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<BoolResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.referralCreate(body, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Returns a boolean indicating whether the passed referrer is valid  Referrers ID: This ID must have been previously registered with the system
...
export const ReferralsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        referralCreate(body?: ReferralCreateBody, options?: any): AxiosPromise<BoolResponse> {
            return localVarFp.referralCreate(body, options).then((request) => request(axios, basePath));
        },
        /**
         * Returns a boolean indicating whether the passed referrer is valid  Referrers ID: This ID must have been previously registered with the system
         * @param {string} referrerId 
...
export class ReferralsApi extends BaseAPI {
     ...
     */
    public referralCreate(body?: ReferralCreateBody, options?: any) {
        return ReferralsApiFp(this.configuration).referralCreate(body, options).then((request) => request(this.axios, this.basePath));
    }
