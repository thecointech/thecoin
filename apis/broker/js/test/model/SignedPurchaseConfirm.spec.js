...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheBrokerCad.SignedPurchaseConfirm();
  });
  ...
  describe('SignedPurchaseConfirm', function() {
    it('should create an instance of SignedPurchaseConfirm', function() {
      // uncomment below and update the code to test SignedPurchaseConfirm
      //var instane = new TheBrokerCad.SignedPurchaseConfirm();
      //expect(instance).to.be.a(TheBrokerCad.SignedPurchaseConfirm);
    });
