...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheBrokerCad.SellRequest();
  });
  ...
  describe('SellRequest', function() {
    it('should create an instance of SellRequest', function() {
      // uncomment below and update the code to test SellRequest
      //var instane = new TheBrokerCad.SellRequest();
      //expect(instance).to.be.a(TheBrokerCad.SellRequest);
    });
