...
namespace haxe.lang {
	public sealed class FieldLookup {
		...
		protected static int[] fieldIds = new int[]{105, 4745537, 4849249, 5393365, 5442204, 5594513, 57476627, 76061764, 87367608, 142301684, 328878574, 359333139, 407283053, 452737314, 501039929, 520590566, 946786476, 1067353468, 1103412149, 1181037546, 1204816148, 1224901875, 1228056441, 1247875546, 1280845662, 1282943179, 1352786672, 1398464674, 1431819701, 1436822557, 1532710347, 1620824029, 1621420777, 1623148745, 1705629508, 1768617329, 1915412854, 1916009602, 2004754604, 2025055113, 2054707467, 2077860402, 2082663554, 2127021138};
		
		protected static string[] fields = new string[]{"i", "__a", "arr", "len", "map", "pop", "getEnumConstructs", "remove", "filter", "resize", "iterator", "lastIndexOf", "hasNext", "reverse", "insert", "length", "toString", "splice", "copy", "join", "concat", "next", "enumConstructor", "push", "sort", "quicksort", "spliceVoid", "getEnumName", "createEnumIndex", "createEnum", "concatNative", "__unsafe_get", "__unsafe_set", "indexOf", "toDynamic", "allEnums", "__get", "__set", "toCoin", "unshift", "enumParameters", "toHuman", "shift", "slice"};
