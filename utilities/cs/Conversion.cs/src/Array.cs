...
public sealed class Array<T> : global::haxe.lang.HxObject, global::Array {
	...
	protected static void __hx_ctor__Array<T_c>(global::Array<T_c> __hx_this, T_c[] native) {
		__hx_this.length = ( native as global::System.Array ).Length;
		__hx_this.__a = native;
	}
	
	
	protected static void __hx_ctor__Array<T_c>(global::Array<T_c> __hx_this) {
		__hx_this.length = 0;
...
namespace _Array {
	public sealed class ArrayIterator<T> : global::haxe.lang.HxObject, global::_Array.ArrayIterator {
		...
		protected static void __hx_ctor__Array_ArrayIterator<T_c>(global::_Array.ArrayIterator<T_c> __hx_this, global::Array<T_c> a) {
			__hx_this.arr = a;
